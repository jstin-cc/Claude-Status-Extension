...
const SHARED_JS_GLOBALS = {
  ...
  INDICATOR_STATUS: 'readonly',
  ERROR_CODES: 'readonly',
  ERROR_LABELS: 'readonly',
  SHARED_STATUS_LABELS: 'readonly',
  UI_LABELS: 'readonly',
  getOverallStatus: 'readonly',
  getOverallColor: 'readonly',
  isWorseStatus: 'readonly',
  isRecoveryStatus: 'readonly',
  buildStatusPayload: 'readonly',
  validateSummary: 'readonly',
  validateIncidents: 'readonly',
  classifyFetchError: 'readonly',
  formatLastChecked: 'readonly',
  csmEl: 'readonly',
  csmIcon: 'readonly',
};
